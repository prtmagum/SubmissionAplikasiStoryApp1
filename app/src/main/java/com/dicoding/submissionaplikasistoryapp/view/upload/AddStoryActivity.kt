...
import com.dicoding.submissionaplikasistoryapp.data.di.createCustomTempFile
import com.dicoding.submissionaplikasistoryapp.data.di.reduceFileImage
import com.dicoding.submissionaplikasistoryapp.data.di.rotateBitmap
import com.dicoding.submissionaplikasistoryapp.data.di.uriToFile
    ...
    private fun takePicture() {
        ...
        createCustomTempFile(application).also {
            val photoURI: Uri = FileProvider.getUriForFile(
                this@AddStoryActivity,
                "com.dicoding.submissionaplikasistoryapp.fileprovider",
                it
            )
